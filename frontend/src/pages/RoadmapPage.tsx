...
const groups: FeatureGroup[] = [
  {
    ...
    features: [
      ...
      { name: '书页间 · 进度快捷更新', desc: '在读卡片上直接更新已读页数，无需进入编辑表单', status: 'done' },
      { name: '书页间 · 阅读统计', desc: '展示总计书数、今年读完数、累计页数等数据', status: 'done' },
      { name: '书页间 · 分类筛选', desc: '在状态 Tab 基础上叠加分类过滤，书多了更好找', status: 'planned', priority: 'low' },
      { name: '书页间 · 详情展开', desc: '点击卡片展开完整读后感与书籍信息', status: 'planned', priority: 'low' },
      { name: '书页间 · 自定义排序', desc: '支持按完成日期、评分排序已读列表', status: 'planned', priority: 'low' },
